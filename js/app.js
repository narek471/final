...
$(window).scroll(function(){
    if ($(this).scrollTop() > 380) {
        $('#dynamic8').addClass('newClass8');
    } else {
        $('#dynamic8').removeClass('newClass8');
    }
});

$(window).scroll(function(){
    if ($(this).scrollTop() > 480) {
        $('#dynamic9').addClass('newClass9');
    } else {
        $('#dynamic9').removeClass('newClass9');
    }
});

$(window).scroll(function(){
    if ($(this).scrollTop() > 480) {
        $('#dynamic10').addClass('newClass10');
    } else {
        $('#dynamic10').removeClass('newClass10');
    }
});
...
$(window).scroll(function(){
    if ($(this).scrollTop() > 740) {
        ...
        $('#dynamic45').removeClass('newClass45');
...
$(window).scroll(function(){
    if ($(this).scrollTop() > 710) {
        ...
        $('#dynamic52').removeClass('newClass52');
    }
});
...
$(window).scroll(function(){
    if ($(this).scrollTop() > 1080) {
        $('#dynamic13').addClass('newClass13');
        $('#dynamic14').addClass('newClass14');
    } else {
        $('#dynamic13').removeClass('newClass13');
        $('#dynamic14').removeClass('newClass14');
    }
});
...
$(window).scroll(function(){
    if ($(this).scrollTop() > 1080) {
        ...
        $('#dynamic36').removeClass('newClass36');
        $('#dynamic53').removeClass('newClass53');
        $('#dynamic54').removeClass('newClass54');
    }
});
...
$(window).scroll(function(){
    if ($(this).scrollTop() > 1480) {
        ...
        $('#dynamic40').addClass('newClass40');
        $('#dynamic55').addClass('newClass55');
        $('#dynamic56').addClass('newClass56');
        $('#dynamic57').addClass('newClass57');
        $('#dynamic58').addClass('newClass58');
    } else {
        $('#dynamic37').removeClass('newClass37');
        $('#dynamic38').removeClass('newClass38');
        $('#dynamic39').removeClass('newClass39');
        $('#dynamic40').removeClass('newClass40');
        $('#dynamic55').removeClass('newClass55');
...
$(window).scroll(function(){
    if ($(this).scrollTop() > 3300) {
        ...
        $('#dynamic80').addClass('newClass80');
        $('#dynamic89').addClass('newClass89');
        $('#dynamic90').addClass('newClass90');
    } else {
        $('#dynamic69').removeClass('newClass69');
        $('#dynamic70').removeClass('newClass70');
        $('#dynamic79').removeClass('newClass79');
        $('#dynamic80').removeClass('newClass80');
        $('#dynamic89').removeClass('newClass89');
        $('#dynamic90').removeClass('newClass90');
    }
});
...
$(window).scroll(function(){
    if ($(this).scrollTop() > 3800) {
        ...
        $('#dynamic81').addClass('newClass81');
        $('#dynamic92').addClass('newClass92');
        $('#dynamic91').addClass('newClass91');
    } else {
        $('#dynamic72').removeClass('newClass72');
        $('#dynamic71').removeClass('newClass71');
        $('#dynamic82').removeClass('newClass82');
        $('#dynamic81').removeClass('newClass81');
        $('#dynamic92').removeClass('newClass92');
        $('#dynamic91').removeClass('newClass91');
    }
});
...
$(window).scroll(function(){
    if ($(this).scrollTop() > 500) {
        ...
        $('#dynamic27').addClass('newClass27');
        $('#dynamic28').addClass('newClass28');
    } else {
        $('#dynamic25').removeClass('newClass25');
        $('#dynamic26').removeClass('newClass26');
        $('#dynamic27').removeClass('newClass27');
        $('#dynamic28').removeClass('newClass28');
    }
});
