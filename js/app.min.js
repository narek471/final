...
(() => {
    ...
    function n(e = {}, r = {}) {
        Object.keys(r).forEach((i => {
            void 0 === e[i] ? e[i] = r[i] : t(r[i]) && t(e[i]) && Object.keys(r[i]).length > 0 && n(e[i], r[i])
        }))
    }
    ...
    function p(e) {
        return function (...t) {
            if (void 0 === t[0]) {
                for (let t = 0; t < this.length; t += 1) d.indexOf(e) < 0 && (e in this[t] ? this[t][e]() : u(this[t]).trigger(e));
                return this
            }
            return this.on(e, ...t)
        }
    ...
    const f = {
        addClass: function (...e) {
            ...
            function o(e) {
                ...
                if (i.indexOf(e) < 0 && i.unshift(e), u(t).is(n)) r.apply(t, i); else {
                    const e = u(t).parents();
            ...
            if ("string" == typeof e) {
                ...
                for (o = u(e), l = 0; l < o.length; l += 1) if (o[l] === r) return !0;
                return !1
            }
            if (e === n) return r === n;
            if (e === t) return r === t;
    ...
    Object.keys(f).forEach((e => {
        Object.defineProperty(u.fn, e, {value: f[e], writable: !0})
    }));
    const h = u;
    ...
    function x({swiper: e, targetPosition: t, side: n}) {
        ...
        const c = t > i ? "next" : "prev", u = (e, t) => "next" === c && e >= t || "prev" === c && e <= t, d = () => {
            ...
            const s = Math.max(Math.min((o - a) / l, 1), 0), c = .5 - Math.cos(s * Math.PI) / 2;
            let p = i + c * (t - i);
            if (u(p, t) && (p = t), e.wrapperEl.scrollTo({[n]: p}), u(p, t)) return e.wrapperEl.style.overflow = "hidden", e.wrapperEl.style.scrollSnapType = "", setTimeout((() => {
    ...
    const C = {
        ...
        updateSize: function () {
            ...
            let x = r.spaceBetween, w = -m, S = 0, T = 0;
            if (void 0 === o) return;
            "string" == typeof x && x.indexOf("%") >= 0 && (x = parseFloat(x.replace("%", "")) / 100 * o), e.virtualSize = -x, s ? u.css({
                marginLeft: "",
                marginBottom: "",
                marginTop: ""
            }) : u.css({
            ...
            for (let i = 0; i < d; i += 1) {
                ...
                if (E && e.grid.updateSlide(i, s, d, t), "none" !== s.css("display")) {
                    if ("auto" === r.slidesPerView) {
                        ...
                        if (a && (s[0].style.transform = "none"), l && (s[0].style.webkitTransform = "none"), r.roundLengths) C = e.isHorizontal() ? s.outerWidth(!0) : s.outerHeight(!0); else {
                            const e = n(o, "width"), t = n(o, "padding-left"), r = n(o, "padding-right"),
                                i = n(o, "margin-left"), a = n(o, "margin-right"), l = o.getPropertyValue("box-sizing");
                    ...
                    u[i] && (u[i].swiperSlideSize = C), h.push(C), r.centeredSlides ? (w = w + C / 2 + S / 2 + x, 0 === S && 0 !== i && (w = w - o / 2 - x), 0 === i && (w = w - o / 2 - x), Math.abs(w) < .001 && (w = 0), r.roundLengths && (w = Math.floor(w)), T % r.slidesPerGroup == 0 && p.push(w), f.push(w)) : (r.roundLengths && (w = Math.floor(w)), (T - Math.min(e.params.slidesPerGroupSkip, T)) % e.params.slidesPerGroup == 0 && p.push(w), f.push(w), w = w + C + x), e.virtualSize += C + x, S = C, T += 1
                }
            }
            if (e.virtualSize = Math.max(e.virtualSize, o) + g, s && a && ("slide" === r.effect || "coverflow" === r.effect) && i.css({width: `${e.virtualSize + r.spaceBetween}px`}), r.setWrapperSize && i.css({[t("width")]: `${e.virtualSize + r.spaceBetween}px`}), E && e.grid.updateWrapperSize(C, p, t), !r.centeredSlides) {
                const t = [];
    ...
    const j = {
        slideTo: function (e = 0, t = this.params.speed, n = !0, r, i) {
            ...
            const v = -l[g];
            if (o.updateProgress(v), a.normalizeSlideIndex) for (let e = 0; e < c.length; e += 1) {
                const t = -Math.floor(100 * v), n = Math.floor(100 * c[e]), r = Math.floor(100 * c[e + 1]);
            ...
            if (a.cssMode) {
                ...
                if (0 === t) {
                    ...
                    if (!o.support.smoothScroll) return x({swiper: o, targetPosition: n, side: e ? "left" : "top"}), !0;
            ...
            const i = this;
            let o = i.activeIndex;
            const s = Math.min(i.params.slidesPerGroupSkip, o), a = s + Math.floor((o - s) / i.params.slidesPerGroup),
            ...
            if (t.loop) {
                ...
                i = parseInt(h(e.clickedSlide).attr("data-swiper-slide-index"), 10), t.centeredSlides ? o < e.loopedSlides - r / 2 || o > e.slides.length - e.loopedSlides + r / 2 ? (e.loopFix(), o = n.children(`.${t.slideClass}[data-swiper-slide-index="${i}"]:not(.${t.slideDuplicateClass})`).eq(0).index(), m((() => {
                    e.slideTo(o)
        ...
        loopCreate: function () {
            const e = this, t = i(), {params: n, $wrapperEl: r} = e,
                o = r.children().length > 0 ? h(r.children()[0].parentNode) : r;
            ...
            for (let e = 0; e < l.length; e += 1) o.append(h(l[e].cloneNode(!0)).addClass(n.slideDuplicateClass));
            for (let e = a.length - 1; e >= 0; e -= 1) o.prepend(h(a[e].cloneNode(!0)).addClass(n.slideDuplicateClass))
        }, loopFix: function () {
            const e = this;
            ...
            t < r ? (l = n.length - 3 * r + t, l += r, e.slideTo(l, 0, !1, !0) && 0 !== c && e.setTranslate((a ? -e.translate : e.translate) - c)) : t >= n.length - r && (l = -n.length + t + r, l += r, e.slideTo(l, 0, !1, !0) && 0 !== c && e.setTranslate((a ? -e.translate : e.translate) - c)), e.allowSlidePrev = i, e.allowSlideNext = o, e.emit("loopFix")
    ...
    function q(e) {
        const t = this, n = i(), r = s(), o = t.touchEventsData, {params: a, touches: l, enabled: c} = t;
        if (!c) return;
        ...
        if (Object.assign(o, {
            ...
            isScrolling: void 0,
            startMoving: void 0
        }), l.startX = m, l.startY = v, o.touchStartTime = g(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, a.threshold > 0 && (o.allowThresholdMove = !1), "touchstart" !== u.type) {
            let e = !0;
            d.is(o.focusableElements) && (e = !1), n.activeElement && h(n.activeElement).is(o.focusableElements) && n.activeElement !== d[0] && n.activeElement.blur();
    ...
    function D(e) {
        ...
        const u = "touchmove" === c.type && c.targetTouches && (c.targetTouches[0] || c.changedTouches[0]),
            d = "touchmove" === c.type ? u.pageX : c.pageX, p = "touchmove" === c.type ? u.pageY : c.pageY;
        ...
        if (void 0 === r.isScrolling) {
            let e;
            n.isHorizontal() && s.currentY === s.startY || n.isVertical() && s.currentX === s.startX ? r.isScrolling = !1 : f * f + m * m >= 25 && (e = 180 * Math.atan2(Math.abs(m), Math.abs(f)) / Math.PI, r.isScrolling = n.isHorizontal() ? e > o.touchAngle : 90 - e > o.touchAngle)
        }
        ...
        n.allowClick = !1, !o.cssMode && c.cancelable && c.preventDefault(), o.touchMoveStopPropagation && !o.nested && c.stopPropagation(), r.isMoved || (o.loop && !o.cssMode && n.loopFix(), r.startTranslate = n.getTranslate(), n.setTransition(0), n.animating && n.$wrapperEl.trigger("webkitTransitionEnd transitionend"), r.allowMomentumBounce = !1, !o.grabCursor || !0 !== n.allowSlideNext && !0 !== n.allowSlidePrev || n.setGrabCursor(!0), n.emit("sliderFirstMove", c)), n.emit("sliderMove", c), r.isMoved = !0;
    ...
    function P(e) {
        ...
        const c = g(), u = c - n.touchStartTime;
        if (t.allowClick) {
        ...
        const h = (d - s[p]) / f, v = p < r.slidesPerGroupSkip - 1 ? 1 : r.slidesPerGroup;
        if (u > r.longSwipesMs) {
            if (!r.longSwipes) return void t.slideTo(t.activeIndex);
            "next" === t.swipeDirection && (h >= r.longSwipesRatio ? t.slideTo(p + v) : t.slideTo(p)), "prev" === t.swipeDirection && (h > 1 - r.longSwipesRatio ? t.slideTo(p + v) : t.slideTo(p))
        } else {
    ...
    const I = (e, t) => {
        const n = i(), {params: r, touchEvents: o, el: s, wrapperEl: a, device: l, support: c} = e, u = !!r.nested,
            d = "on" === t ? "addEventListener" : "removeEventListener", p = t;
        if (c.touch) {
            const t = !("touchstart" !== o.start || !c.passiveListener || !r.passiveListeners) && {
                passive: !0,
                capture: !1
            };
            s[d](o.start, e.onTouchStart, t), s[d](o.move, e.onTouchMove, c.passiveListener ? {
                passive: !1,
                capture: u
            } : u), s[d](o.end, e.onTouchEnd, t), o.cancel && s[d](o.cancel, e.onTouchEnd, t)
        } else s[d](o.start, e.onTouchStart, !1), n[d](o.move, e.onTouchMove, u), n[d](o.end, e.onTouchEnd, !1);
        (r.preventClicks || r.preventClicksPropagation) && s[d]("click", e.onClick, !0), r.cssMode && a[d]("scroll", e.onScroll), r.updateOnWindowResize ? e[p](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", B, !0) : e[p]("observerUpdate", B, !0)
    }, H = {
        attachEvents: function () {
            const e = this, t = i(), {params: n, support: r} = e;
            e.onTouchStart = q.bind(e), e.onTouchMove = D.bind(e), e.onTouchEnd = P.bind(e), n.cssMode && (e.onScroll = M.bind(e)), e.onClick = N.bind(e), r.touch && !O && (t.addEventListener("touchstart", _), O = !0), I(e, "on")
        }, detachEvents: function () {
            I(this, "off")
        }
    }, z = (e, t) => e.grid && t.grid && t.grid.rows > 1, R = {
        addClasses: function () {
            const e = this, {classNames: t, params: n, rtl: r, $el: i, device: o, support: s} = e, a = function (e, t) {
                const n = [];
                return e.forEach((e => {
    ...
    const W = {
        eventsEmitter: C, update: k, translate: {
            ...
            setBreakpoint: function () {
                ...
                c && !u ? (o.removeClass(`${i.containerModifierClass}grid ${i.containerModifierClass}grid-column`), e.emitContainerClasses()) : !c && u && (o.addClass(`${i.containerModifierClass}grid`), (l.grid.fill && "column" === l.grid.fill || !l.grid.fill && "column" === i.grid.fill) && o.addClass(`${i.containerModifierClass}grid-column`), e.emitContainerClasses());
    ...
    class X {
        constructor(...e) {
            let t, n;
            if (1 === e.length && e[0].constructor && "Object" === Object.prototype.toString.call(e[0]).slice(8, -1) ? n = e[0] : [t, n] = e, n || (n = {}), n = y({}, n), t && !n.el && (n.el = t), n.el && h(n.el).length > 1) {
                const e = [];
            ...
            r.__swiper__ = !0, r.support = E(), r.device = function (e = {}) {
                return S || (S = function ({userAgent: e} = {}) {
                    const t = E(), n = s(), r = n.navigator.platform, i = e || n.navigator.userAgent,
                        o = {ios: !1, android: !1}, a = n.screen.width, l = n.screen.height,
                        c = i.match(/(Android);?[\s\/]+([\d.]+)?/);
                    let u = i.match(/(iPad).*OS\s([\d_]+)/);
                    const d = i.match(/(iPod)(.*OS\s([\d_]+))?/), p = !u && i.match(/(iPhone\sOS|iOS)\s([\d_]+)/),
                        f = "Win32" === r;
                    let h = "MacIntel" === r;
                    return !u && h && t.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${a}x${l}`) >= 0 && (u = i.match(/(Version)\/([\d.]+)/), u || (u = [0, 1, "13_0_0"]), h = !1), c && !f && (o.os = "android", o.android = !0), (u || p || d) && (o.os = "ios", o.ios = !0), o
                }(e)), S
            }({userAgent: n.userAgent}), r.browser = (T || (T = function () {
                const e = s();
                return {
                    isSafari: function () {
            ...
            }()), T), r.eventsListeners = {}, r.eventsAnyListeners = [], r.modules = [...r.__modules__], n.modules && Array.isArray(n.modules) && r.modules.push(...n.modules);
            const i = {};
            r.modules.forEach((e => {
                e({
                    swiper: r,
            ...
            const o = y({}, G, i);
            return r.params = y({}, o, V, n), r.originalParams = y({}, r.params), r.passedParams = y({}, n), r.params && r.params.on && Object.keys(r.params.on).forEach((e => {
        ...
        mount(e) {
            ...
            if (0 === o.length && t.params.createElements) {
                ...
                o = h(e), e.className = t.params.wrapperClass, n.append(e), n.children(`.${t.params.slideClass}`).each((e => {
                    o.append(e)
                }))
            }
    ...
    function U({swiper: e, extendParams: t, on: n, emit: r}) {
        function o(t) {
            let n;
        ...
        function u() {
            ...
            const n = o(t.nextEl), r = o(t.prevEl);
            n && n.length > 0 && n.on("click", c), r && r.length > 0 && r.on("click", l), Object.assign(e.navigation, {
                $nextEl: n,
                nextEl: n && n[0],
                $prevEl: r,
                prevEl: r && r[0]
        ...
        function d() {
            const {$nextEl: t, $prevEl: n} = e.navigation;
            t && t.length && (t.off("click", c), t.removeClass(e.params.navigation.disabledClass)), n && n.length && (n.off("click", l), n.removeClass(e.params.navigation.disabledClass))
        }
        ...
        t({
            ...
            if (e.params.navigation.hideOnClick && !h(s).is(o) && !h(s).is(i)) {
        ...
        })), Object.assign(e.navigation, {update: a, init: u, destroy: d})
    }

    function J({swiper: e, extendParams: t, on: n, emit: r}) {
        let o;

        function s() {
            const t = e.slides.eq(e.activeIndex);
            let n = e.params.autoplay.delay;
            t.attr("data-swiper-autoplay") && (n = t.attr("data-swiper-autoplay") || e.params.autoplay.delay), clearTimeout(o), o = m((() => {
                let t;
        ...
        function a() {
            return void 0 === o && !e.autoplay.running && (e.autoplay.running = !0, r("autoplayStart"), s(), !0)
        }

        function l() {
            return !!e.autoplay.running && void 0 !== o && (o && (clearTimeout(o), o = void 0), e.autoplay.running = !1, r("autoplayStop"), !0)
        }
        ...
        e.autoplay = {running: !1, paused: !1}, t({
            ...
            e.params.autoplay.enabled && (a(), i().addEventListener("visibilitychange", u), e.params.autoplay.pauseOnMouseEnter && (e.$el.on("mouseenter", p), e.$el.on("mouseleave", f)))
            ...
            e.$el.off("mouseenter", p), e.$el.off("mouseleave", f), e.autoplay.running && l(), i().removeEventListener("visibilitychange", u)
    ...
    function K(e, t, n) {
        ...
        e.onwheel = function (e) {
            return e.deltaY < 0 && (r += 27), r > 200 && 0 !== t ? (r = 0, void t.click()) : (e.deltaY > 0 && (r -= 27), r < -200 && 0 !== n ? (r = 0, void n.click()) : void 0)
        }
    }
    ...
    function Q(e, t, n) {
        let r = 0, i = 0;
        e.onwheel = function (e) {
            return e.deltaY < 0 && (r += 27), r > 70 && 0 !== t ? (t.click(), void (r = 0)) : (e.deltaY > 0 && (i -= 27), i < -70 && 0 !== n ? (n.click(), void (i = 0)) : void 0)
        }
    }

    function Z(e, t, n) {
        return -1 === e ? t.classList.remove(n) : 1 === e ? t.classList.add(n) : 2 === e ? t.classList.toggle(n) : (console.log("Lib error Change"), !1)
    }

    function ee() {
        var e;
        new Y(".slider-a-js--on", {
            modules: [J, U],
            allowSlideNext: !0,
            allowSlidePrev: !0,
            grabCursor: !1,
            ...
            navigation: {nextEl: ".--js_swiper__nav-next", prevEl: ".--js_swiper__nav-prev"}
        }), new Y(".slider-b-js--on", {
            modules: [J, U],
            allowSlideNext: !0,
            allowSlidePrev: !0,
            grabCursor: !1,
            ...
            spaceBetween: 60,
            initialSlide: 1,
            breakpoints: {900: {slidesPerView: 2, spaceBetween: 30, initialSlide: 1, slidesPerGroup: 1}},
            autoHeight: !1,
            loop: !0,
            loopedSlides: 2,
            speed: 2900,
            ...
            navigation: {nextEl: ".--js_swiper__nav-next--b", prevEl: ".--js_swiper__nav-prev--b"}
        }), function () {
            const e = document.querySelector(".form-mess__textarea"), t = document.querySelector("._email"),
                n = document.querySelector(".form-mess-btn");

            function r() {
                t.value.length > 5 && e.value.length > 5 && n.classList.add("--js_btn-on"), (t.value.length < 5 || e.value.length < 5) && n.classList.remove("--js_btn-on")
            }
            ...
            const e = document.documentElement.scrollWidth, t = document.documentElement.scrollHeight,
                n = document.querySelector("#accordionACheck"), r = document.querySelector("#heroScreenNextBtn"),
                i = document.querySelector(".preloader"), o = document.querySelector(".hero-screen"),
                s = document.querySelector(".services"), a = document.querySelector("#servicesBtnPrev"),
                l = document.querySelector(".--js_services-map-scroll"), c = document.querySelector("#servicesBtnNext"),
                u = document.querySelector(".nft"), d = document.querySelector("#nftBtnPrev"),
                p = document.querySelector("#nftBtnNext"), f = document.querySelector("#jobsAbout"),
                h = document.querySelector(".jobs"), m = document.querySelector("#jobsBtnPrev"),
                g = document.querySelector("#jobsBtnNext"), v = document.querySelector(".about"),
                y = document.querySelector("#aboutBtnPrev"), b = document.querySelector("#aboutBtnNext"),
                x = document.querySelector(".contacts"), w = document.querySelector("#contactsBtnPrev");
            e < 1020 ? function (e, t, n) {
                let r = new IntersectionObserver((function (e) {
                    e.forEach((e => {
                        e.isIntersecting && function (e, t) {
                            let n = 0;
                            e.onwheel = function (e) {
                                e.deltaY > 0 && (n += 27), n > 200 ? t.click() : e.deltaY < 0 && (n = 0)
                            }
                        }(t, n)
                    }))
                }), {threshold: [.5]}), i = document.querySelectorAll(".--js_mark-bottom");
                for (let e of i) r.observe(e)
            }(0, o, r) : Q(o, 0, r), r.addEventListener("click", (function (e) {
                e.preventDefault(), G(), setTimeout((() => {
                    W(s)
                }), 4)
            })), e < 1020 ? K(l, a, c) : Q(l, a, c), a.addEventListener("click", (function (e) {
                e.preventDefault(), F(s), setTimeout((() => {
                    o.classList.remove("--js-hidden"), o.classList.add("--js_return")
                }), 1200)
            })), c.addEventListener("click", (function (e) {
                e.preventDefault(), F(s), setTimeout((() => {
                    W(u)
                }), 1200)
            })), e < 1020 && t > 800 && K(u, d, p), e < 1020 && t < 800 ? function (e, t, n) {
                console.log("Мобилка");
                let r = 0;
                e.onwheel = function (e) {
                    return e.deltaY < 0 && (r += 27), r > 300 && 0 !== t ? (t.click(), r = 0) : (e.deltaY > 0 && (r -= 27), r < -300 && 0 !== n ? (n.click(), r = 0) : void 0)
                }
            }(u, d, p) : Q(u, d, p), d.addEventListener("click", (function (e) {
                e.preventDefault(), F(u), setTimeout((() => {
                    W(s)
                }), 1200)
            })), p.addEventListener("click", (function (e) {
                e.preventDefault(), F(u), u.classList.add("--js-hidden-alternative"), setTimeout((() => {
                    R()
                }), 400)
            })), e < 1025 ? K(h, m, g) : Q(h, m, g), m.addEventListener("click", (function (e) {
                e.preventDefault(), f.classList.remove("jobs-about__js-to-right", "js-loading", "--js_return"), f.classList.add("--js-hidden"), setTimeout((() => {
                    W(u)
                }), 1200)
            })), g.addEventListener("click", (function (e) {
                e.preventDefault(), f.classList.remove("js-loading", "jobs-about__js-to-right", "jobs-about__js-to-left", "--js_return"), f.classList.add("jobs-about__js-to-left"), setTimeout((() => {
                    W(v)
                }), 1200), setTimeout((() => {
                    n.click()
                }), 2230)
            })), e < 1020 ? K(v, y, b) : Q(v, y, b), y.addEventListener("click", (function (e) {
                e.preventDefault(), f.classList.remove("--js_return"), f.classList.remove("jobs-about__js-to-left"), f.classList.add("jobs-about__js-to-right")
            })), b.addEventListener("click", (function (e) {
                e.preventDefault(), H(), setTimeout((() => {
                    W(x)
                }), 700)
            })), e < 1020 ? function (e, t, n) {
                let r = 0;
                e.onwheel = function (e) {
                    return e.deltaY < 0 && (r += 27), r > 100 ? (r = 0, void t.click()) : (e.deltaY > 0 && (r -= 27), r < -100 ? void (r = 0) : void 0)
                }
            }(x, w) : Q(x, w, 0), w.addEventListener("click", (function (e) {
                e.preventDefault(), F(x), setTimeout((() => {
                    z()
                }), 800)
            }));
            const S = document.querySelector("#heroBtnNft"), T = document.querySelector("#heroBtnServices"),
                E = document.querySelector("#heroBtnJobs"), C = document.querySelector("#heroBtnAbout"),
                k = document.querySelector("#heroBtnContacts"), L = document.querySelector("#servicesBtnNft"),
                j = document.querySelector("#servicesBtnJobs"), A = document.querySelector("#servicesBtnAbout"),
                q = document.querySelector("#servicesBtnContacts"), D = document.querySelector("#nftBtnJobs"),
                P = document.querySelector("#nftBtnAbout"), B = document.querySelector("#nftBtnContacts"),
                N = document.querySelector("#aboutBtnServices"), M = document.querySelector("#aboutBtnNft"),
                O = document.querySelector("#aboutBtnContacts"), _ = document.querySelector("#contactsBtnServices"),
                $ = document.querySelector("#contactsBtnNft"), I = document.querySelector("#contactsBtnJobs"),
                Wy = document.querySelector("#nft__link1"), Wa = document.querySelector("#nft__link2"),
                Wb = document.querySelector("#nft__link3"), Wc = document.querySelector("#nft__link4"),
                Wd = document.querySelector("#nft__link5"), We = document.querySelector("#nft__link6"),
                Wf = document.querySelector("#services__link1"), Wg = document.querySelector("#services__link2"),
                Wh = document.querySelector("#services__link3"), Wj = document.querySelector("#services__link4"),
                Wk = document.querySelector("#close_link_contact"), Wl = document.querySelector("#close_link_contact2"),
                Wm = document.querySelector("#close_link_contact3"), Wn = document.querySelector("#close_link_contact4"),
                Wo = document.querySelector("#close_link_contact5"), Wp = document.querySelector("#close_link_contact6"),
                Wq = document.querySelector("#close_link_contact7"), Wr = document.querySelector("#close_link_contact8"),
                Wz = document.querySelector("#close_link_contact9"), Wx = document.querySelector("#close_link_contact10"),
                Ww = document.querySelector("#close_link_contact11");

            function H() {
                f.classList.add("--js-hidden--left"), setTimeout((() => {
                    f.classList.remove("jobs-about__js-to-right", "js-loading", "--js_return")
                }), 1e3)
            }
            ...
            function R() {
                W(f), f.classList.remove("--js-hidden--left")
            }

            function G() {
                i.classList.add("--js-hidden"), i.classList.remove("js-loading"), o.classList.add("--js-hidden"), o.classList.remove("js-loading"), o.classList.remove("--js_return")
            }

            function F(e) {
                e.classList.remove("js-loading", "--js_return"), e.classList.add("--js-hidden")
            }

            function W(e) {
                e.classList.remove("--js-not-visible", "--js-hidden", "--js-hidden-alternative"), e.classList.add("--js_return")
            }
            ...
            S.addEventListener("click", (function (e) {
                ...
                e.preventDefault(), G(), f.classList.remove("js-loading"), setTimeout((() => {
                    z()
                }), 700)
            ...
            })),Wy.addEventListener("click", (function (e) {
                e.preventDefault(), F(u), setTimeout((() => {
                    W(x)
                }), 500)
                ...
                e.preventDefault(), F(f), F(s), setTimeout((() => {
                    W(x)
                }), 500)
            ...
            })),Wq.addEventListener("click", (function (e) {
                e.preventDefault(),F(f), F(s), setTimeout((() => {
                    W(x)
                }), 500)
                ...
                e.preventDefault(),F(f), F(u), setTimeout((() => {
                    W(x)
                }), 500)
            ...
            })),Wj.addEventListener("click", (function (e) {
                e.preventDefault(),F(f), F(s), setTimeout((() =>
                    W(x)),
                    500)
            ...
            const e = document.querySelector(".hero-screen"), t = document.querySelector(".services"),
                n = document.querySelector(".contacts"), r = document.querySelector("#jobsAbout"),
                i = document.querySelector(".nft"), o = document.querySelector("#heroBtnNft"),
                s = document.querySelector("#heroBtnServices"), a = document.querySelector("#heroBtnJobs"),
                l = document.querySelector("#heroBtnAbout"), c = document.querySelector("#heroBtnContacts"),
                u = document.querySelector("#servicesBtnNft"), d = document.querySelector("#servicesBtnJobs"),
                p = document.querySelector("#servicesBtnAbout"), f = document.querySelector("#servicesBtnContacts"),
                h = document.querySelector("#servicesBtnPrev"), m = document.querySelector("#servicesBtnNext"),
                g = document.querySelector("#nftBtnAbout"), v = document.querySelector("#nftBtnContacts"),
                y = document.querySelector("#nftBtnPrev"), b = document.querySelector("#nftBtnNext"),
                x = document.querySelector("#jobsBtnPrev"), w = document.querySelector("#jobsBtnNext"),
                S = document.querySelector("#aboutBtnServices"), T = document.querySelector("#aboutBtnNft"),
                E = document.querySelector("#aboutBtnPrev"), C = document.querySelector("#aboutBtnNext"),
                k = document.querySelector("#hBurgPrevBtn"), L = document.querySelector("#hBurgNextBtn"),
                j = document.querySelector("#hBurgeBtnNft"), A = document.querySelector("#hBurgrBtnServices"),
                q = document.querySelector("#hBurgrBtnJobs"), D = document.querySelector("#hBurgrBtnContacts"),
                P = document.querySelector("#hBurgrBtnAbout"), B = document.querySelector("#sBurgPrevBtn"),
                N = document.querySelector("#sBurgNextBtn"), M = document.querySelector("#sBurgeBtnNft"),
                O = document.querySelector("#sBurgrBtnHome"), _ = document.querySelector("#sBurgrBtnJobs"),
                $ = document.querySelector("#sBurgrBtnContacts"), I = document.querySelector("#sBurgrBtnAbout"),
                H = document.querySelector("#nBurgrBtnHome"), z = document.querySelector("#nBurgPrevBtn"),
                R = document.querySelector("#nBurgNextBtn"), G = document.querySelector("#nBurgeBtnServices"),
                F = document.querySelector("#nBurgrBtnJobs"), W = document.querySelector("#nBurgrBtnContacts"),
                V = document.querySelector("#nBurgrBtnAbout"), X = document.querySelector("#nBurgrBtnHome"),
                Y = document.querySelector("#jBurgPrevBtn"), U = document.querySelector("#jBurgNextBtn"),
                J = document.querySelector("#jBurgeBtnServices"), K = document.querySelector("#jBurgrBtnNft"),
                Q = document.querySelector("#jBurgrBtnAbout"), Z = document.querySelector("#jBurgrBtnContacts"),
                ee = document.querySelector("#aBurgPrevBtn"), te = document.querySelector("#aBurgNextBtn"),
                ne = document.querySelector("#aBurgrBtnHome"), re = document.querySelector("#aBurgeBtnServices"),
                ie = document.querySelector("#aBurgrBtnNft"), oe = document.querySelector("#aBurgrBtnJobs"),
                se = document.querySelector("#aBurgrBtnContacts"), ae = document.querySelector("#cBurgrBtnHome"),
                le = document.querySelector("#contactsBtnServices"), ce = document.querySelector("#contactsBtnNft"),
                ue = document.querySelector("#cBurgPrevBtn"), de = document.querySelector("#cBurgNextBtn"),
                pe = document.querySelector("#contactsBtnPrev"), fe = document.querySelector("#cBurgeBtnServices"),
                he = document.querySelector("#cBurgrBtnNft"), me = document.querySelector("#cBurgrBtnJobs"),
                ge = document.querySelector("#cBurgrBtnAbout");

            function ve(e, t) {
                e && e.addEventListener("click", (function (e) {
                    document.body.classList.remove("--js-lock__body--burgerMenu"), r.classList.remove("js-loading", "--js_return", "jobs-about__js-to-right"), r.classList.add("--js-hidden"), setTimeout((() => {
                        t.classList.remove("--js-not-visible", "--js-hidden"), t.classList.add("--js_return")
            ...
            function ye(e, t) {
                e && e.addEventListener("click", (function (e) {
                    document.body.classList.remove("--js-lock__body--burgerMenu"), t.click(), e.preventDefault()
                }))
            }

            function be(t, n) {
                t && t.addEventListener("click", (function (t) {
                    document.body.classList.remove("--js-lock__body--burgerMenu"), t.preventDefault(), n.classList.remove("js-loading", "--js_return"), n.classList.add("--js-hidden"), setTimeout((() => {
                        e.classList.remove("--js-hidden"), e.classList.add("--js_return")
                    }), 300)
                }))
            }
            ...
            function xe(t) {
                t && t.addEventListener("click", (function (t) {
                    document.body.classList.remove("--js-lock__body--burgerMenu"), t.preventDefault(), r.classList.remove("js-loading", "--js_return", "jobs-about__js-to-right"), r.classList.add("--js-hidden"), setTimeout((() => {
                        e.classList.remove("--js-hidden"), e.classList.add("--js_return")
                    }), 400)
                }))
            }

            ye(k, c), ye(L, s), ye(D, c), ye(A, s), ye(q, a), ye(j, o), ye(P, l), ye(B, h), ye(N, m), ye($, f), ye(O, h), ye(M, u), ye(_, d), ye(I, p), ye(z, y), ye(R, b), be(H, i), ye(G, y), ye(W, v), ye(F, b), ye(V, g), ye(Y, x), ye(U, w), xe(X), ve(J, t), ye(K, x), ye(Q, w), ve(Z, n), ye(ee, E), ye(te, C), xe(ne), ye(re, S), ye(se, C), ye(oe, E), ye(ie, T), ye(ue, pe), ye(de, ae), be(ae, n), ye(fe, le), ye(ge, pe), ye(me, pe), ye(he, ce)
        }(), function () {
            const e = document.querySelectorAll(".--js_scroll-y"), t = 100;
            let n = -170;
            if (e.length > 0) for (let r = 0; r < e.length; r++) {
                let i = null, o = null, s = e[r];
                ...
                function l(e) {
                    if (!i || !o) return !1;
                    let r = e.touches[0].clientX, a = (e.touches[0].clientY, i - r),
                        l = parseInt(getComputedStyle(s).left);
                    console.log(a), a > 0 && n < 200 && (console.log("ВПРАВО"), n += 25, s.style.left = l - t + "px", s.style.left = l - t + "px"), a < 0 && n > -200 && (n -= 25, s.style.left = l + t + "px", s.style.left = l + t + "px"), i = null
                }

                s.addEventListener("touchstart", a, !1), s.addEventListener("touchmove", l, !1)
            }
        }(), te("#popUpGalleryA", "#popUpGalleryALef", "#popUpGalleryAright"), te("#popUpGalleryB", "#popUpGalleryBLef", "#popUpGalleryBright"), te("#popUpGalleryC", "#popUpGalleryCLef", "#popUpGalleryCright"), te("#popUpGalleryD", "#popUpGalleryDLef", "#popUpGalleryDright"), function () {
            const e = document.querySelector(".--js-thumb_target-a"), t = document.querySelector(".--js-thumb_mark-a"),
                n = document.querySelector(".--js-thumb_mark-ab"), r = document.querySelector(".--js-thumb_target-b"),
                i = document.querySelector(".--js-thumb_mark-b"), o = document.querySelector(".--js-thumb_mark-bb"),
                s = document.querySelector(".--js-thumb_target-c"), a = document.querySelector(".--js-thumb_mark-c"),
                l = document.querySelector(".--js-thumb_mark-cb");

            function c(e, t, n) {
                e.onmousedown = function (e) {
                    e.preventDefault();
                    let r = e.clientX, i = parseInt(getComputedStyle(t).left);

                    function o(e) {
                        let o = e.clientX - r;
                        o > n && (o = n), o < -n && (o = -n), t.style.left = i + o + "px"
                    }
            ...
            function u(e, t, n) {
                if (e) {
                    ...
                    function s(e) {
                        if (!r || !i) return !1;
                        let n = e.touches[0].clientX, o = (e.touches[0].clientY, r - n),
                            s = parseInt(getComputedStyle(t).left);
                        return o > 0 && s > -200 ? (t.style.left = s - 300 + "px", void (t.style.transition = "left 1s ease-out ")) : o < 0 && s < 200 ? (t.style.left = s + 300 + "px", void (t.style.transition = "left 1s ease-out ")) : void (r = null)
                    }

                    e.addEventListener("touchstart", o, !1), e.addEventListener("touchmove", s, !1)
                }
            }

            c(t, e, 500), c(n, e, 600), c(i, r, 600), c(o, r, 500), c(a, s, 500), c(l, s, 700), u(t, e), u(n, e), u(i, r), u(o, r), u(a, s), u(l, s)
        }(), (e = ".--js_btn-glr", document.querySelectorAll(e)).forEach((e => {
            e.addEventListener("click", (function (t) {
                Z(1, e, "--js_anm"), setTimeout((() => {
                    Z(-1, e, "--js_anm")
                }), 1400)
            }))
        }))
    ...
    function te(e, t, n) {
        const r = document.querySelector(e), i = document.querySelector(t), o = document.querySelector(n);
        let s = 0;
        r.onwheel = function (e) {
            if (r) {
                let t = parseInt(getComputedStyle(i).top), n = parseInt(getComputedStyle(o).top);
                e.deltaY > 0 && s < 400 && (s += 25, i.style.top = t + 30 + "px", o.style.top = n - 30 + "px"), e.deltaY < 0 && s > -400 && (s -= 25, i.style.top = t - 30 + "px", o.style.top = n + 30 + "px")
            }
        }
    }
    ...
    function re(e) {
        e.parentElement.classList.remove("_error"), e.classList.remove("_error")
    }
    ...
    document.querySelector("body"), document.querySelector("header").offsetHeight, function (e) {
        let t = new Image;
        ...
        !function () {
            var e, t;
            e = "undefined" != typeof window ? window : this, t = function (e, t) {
                var n = [], r = Object.getPrototypeOf, i = n.slice, o = n.flat ? function (e) {
                        return n.flat.call(e)
                    } : function (e) {
                        return n.concat.apply([], e)
                    }, s = n.push, a = n.indexOf, l = {}, c = l.toString, u = l.hasOwnProperty, d = u.toString,
                    p = d.call(Object), f = {}, h = function (e) {
                ...
                w.fn = w.prototype = {
                    ...
                    for ("boolean" == typeof s && (c = s, s = arguments[a] || {}, a++), "object" == typeof s || h(s) || (s = {}), a === l && (s = this, a--); a < l; a++) if (null != (e = arguments[a])) for (t in e) r = e[t], "__proto__" !== t && s !== r && (c && r && (w.isPlainObject(r) || (i = Array.isArray(r))) ? (n = s[t], o = i && !Array.isArray(n) ? [] : i || w.isPlainObject(n) ? n : {}, i = !1, s[t] = w.extend(c, o, r)) : void 0 !== r && (s[t] = r));
                    return s
                }, w.extend({
                    expando: "jQuery" + (x + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (e) {
                        ...
                        var n = t || [];
                        return null != e && (S(Object(e)) ? w.merge(n, "string" == typeof e ? [e] : e) : s.call(n, e)), n
                ...
                var T = function (e) {
                    var t, n, r, i, o, s, a, l, c, u, d, p, f, h, m, g, v, y, b, x = "sizzle" + 1 * new Date,
                        w = e.document, S = 0, T = 0, E = le(), C = le(), k = le(), L = le(), j = function (e, t) {
                            return e === t && (d = !0), 0
                        }, A = {}.hasOwnProperty, q = [], D = q.pop, P = q.push, B = q.push, N = q.slice,
                        M = function (e, t) {
                        ...
                        R = new RegExp("^" + _ + "+|((?:^|[^\\\\])(?:\\\\.)*)" + _ + "+$", "g"),
                        G = new RegExp("^" + _ + "*," + _ + "*"),
                        F = new RegExp("^" + _ + "*([>+~]|" + _ + ")" + _ + "*"), W = new RegExp(_ + "|>"),
                        V = new RegExp(H), X = new RegExp("^" + $ + "$"), Y = {
                            ID: new RegExp("^#(" + $ + ")"),
                            CLASS: new RegExp("^\\.(" + $ + ")"),
                            TAG: new RegExp("^(" + $ + "|[*])"),
                            ATTR: new RegExp("^" + I),
                        ...
                        }, U = /HTML$/i, J = /^(?:input|select|textarea|button)$/i, K = /^h\d$/i,
                        Q = /^[^{]+\{\s*\[native \w/, Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ee = /[+~]/,
                    ...
                    try {
                        B.apply(q = N.call(w.childNodes), w.childNodes), q[w.childNodes.length].nodeType
                    } catch (t) {
                        B = {
                    ...
                    function ae(e, t, r, i) {
                        var o, a, c, u, d, h, v, y = t && t.ownerDocument, w = t ? t.nodeType : 9;
                    ...
                    for (t in n = ae.support = {}, o = ae.isXML = function (e) {
                        ...
                        return s != f && 9 === s.nodeType && s.documentElement && (h = (f = s).documentElement, m = !o(f), w != f && (i = f.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", oe, !1) : i.attachEvent && i.attachEvent("onunload", oe)), n.scope = ue((function (e) {
                            ...
                            return r || (1 & (r = (e.ownerDocument || e) == (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !n.sortDetached && t.compareDocumentPosition(e) === r ? e == f || e.ownerDocument == w && b(w, e) ? -1 : t == f || t.ownerDocument == w && b(w, t) ? 1 : u ? M(u, e) - M(u, t) : 0 : 4 & r ? -1 : 1)
                        } : function (e, t) {
                            if (e === t) return d = !0, 0;
                            var n, r = 0, i = e.parentNode, o = t.parentNode, s = [e], a = [t];
                            if (!i || !o) return e == f ? -1 : t == f ? 1 : i ? -1 : o ? 1 : u ? M(u, e) - M(u, t) : 0;
                                ...
                                return 1 === r && 0 === i ? function (e) {
                                    ...
                                    if (g) {
                                        ...
                                        if (h = [s ? g.firstChild : g.lastChild], s && y) {
                                            for (b = (f = (c = (u = (d = (p = g)[x] || (p[x] = {}))[p.uniqueID] || (d[p.uniqueID] = {}))[e] || [])[0] === S && c[1]) && c[2], p = f && g.childNodes[f]; p = ++f && p && p[m] || (b = f = 0) || h.pop();) if (1 === p.nodeType && ++b && p === t) {
                                                u[e] = [S, f, b];
                                                break
                                            }
                                        } else if (y && (b = f = (c = (u = (d = (p = t)[x] || (p[x] = {}))[p.uniqueID] || (d[p.uniqueID] = {}))[e] || [])[0] === S && c[1]), !1 === b) for (; (p = ++f && p && p[m] || (b = f = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++b || (y && ((u = (d = p[x] || (p[x] = {}))[p.uniqueID] || (d[p.uniqueID] = {}))[e] = [S, b]), p !== t));) ;
                    ...
                    function xe(e, t, n) {
                        var r = t.dir, i = t.next, o = i || r, s = n && "parentNode" === o, a = T++;
                        return t.first ? function (t, n, i) {
                            ...
                            } else for (; t = t[r];) if (1 === t.nodeType || s) if (u = (d = t[x] || (t[x] = {}))[t.uniqueID] || (d[t.uniqueID] = {}), i && i === t.nodeName.toLowerCase()) t = t[r] || t; else {
                    ...
                    function Te(e, t, n, r, i, o) {
                        return r && !r[x] && (r = Te(r)), i && !i[x] && (i = Te(i, o)), ce((function (o, s, a, l) {
                            var c, u, d, p = [], f = [], h = s.length, m = o || function (e, t, n) {
                                    for (var r = 0, i = t.length; r < i; r++) ae(e, t[r], n);
                                    return n
                                }(t || "*", a.nodeType ? [a] : a, []), g = !e || !o && t ? m : Se(m, p, e, a, l),
                                v = n ? i || (o ? e : h || r) ? [] : s : g;
                            if (n && n(g, v, a, l), r) for (c = Se(v, f), r(c, [], a, l), u = c.length; u--;) (d = c[u]) && (v[f[u]] = !(g[f[u]] = d));
                            if (o) {
                                if (i || e) {
                                    if (i) {
                                    ...
                                    for (u = v.length; u--;) (d = v[u]) && -1 < (c = i ? M(o, d) : p[u]) && (o[c] = !(s[c] = d))
                                }
                            } else v = Se(v === s ? v.splice(h, v.length) : v), i ? i(null, s, v, l) : B.apply(s, v)
                        }))
                    }
                    ...
                    function Ee(e) {
                        for (var t, n, i, o = e.length, s = r.relative[e[0].type], a = s || r.relative[" "], l = s ? 1 : 0, u = xe((function (e) {
                            ...
                            if ((n = r.filter[e[l].type].apply(null, e[l].matches))[x]) {
                                ...
                                return Te(1 < l && we(p), 1 < l && be(e.slice(0, l - 1).concat({value: " " === e[l - 2].type ? "*" : ""})).replace(R, "$1"), n, l < i && Ee(e.slice(l, i)), i < o && Ee(e = e.slice(i)), i < o && be(e))
                            }
                            p.push(n)
                        }
                        return we(p)
                    ...
                    return ye.prototype = r.filters = r.pseudos, r.setFilters = new ye, s = ae.tokenize = function (e, t) {
                        ...
                        for (a = e, l = [], c = r.preFilter; a;) {
                            for (s in n && !(i = G.exec(a)) || (i && (a = a.slice(i[0].length) || a), l.push(o = [])), n = !1, (i = F.exec(a)) && (n = i.shift(), o.push({
                                value: n,
                                type: i[0].replace(R, " ")
                        ...
                        var n, i, o, a, l, u, d = [], h = [], g = k[e + " "];
                        if (!g) {
                            for (t || (t = s(e)), n = t.length; n--;) (g = Ee(t[n]))[x] ? d.push(g) : h.push(g);
                            (g = k(e, (i = h, a = 0 < (o = d).length, l = 0 < i.length, u = function (e, t, n, s, u) {
                                var d, h, g, v = 0, y = "0", b = e && [], x = [], w = c,
                                    T = e || l && r.find.TAG("*", u), E = S += null == w ? 1 : Math.random() || .1,
                                    C = T.length;
                                for (u && (c = t == f || t || u); y !== C && null != (d = T[y]); y++) {
                                    if (l && d) {
                                        for (h = 0, t || d.ownerDocument == f || (p(d), n = !m); g = i[h++];) if (g(d, t || f, n)) {
                                            s.push(d);
                                            break
                                        }
                                        u && (S = E)
                                ...
                                if (v += y, a && y !== v) {
                                    ...
                                    B.apply(s, x), u && !e && 0 < x.length && 1 < v + o.length && ae.uniqueSort(s)
                                }
                                return u && (S = E, c = w), b
                            }, a ? ce(u) : u))).selector = e
                        }
                        ...
                        var o, l, c, u, d, p = "function" == typeof e && e, f = !i && s(e = p.selector || e);
                        if (n = n || [], 1 === f.length) {
                            ...
                            for (o = Y.needsContext.test(e) ? 0 : l.length; o-- && (c = l[o], !r.relative[u = c.type]);) if ((d = r.find[u]) && (i = d(c.matches[0].replace(te, ne), ee.test(l[0].type) && ve(t.parentNode) || t))) {
                                if (l.splice(o, 1), !(e = i.length && be(l))) return B.apply(n, i), n;
                                break
                            }
                        }
                        return (p || a(e, f))(i, t, !m, n, !t || ee.test(e) && ve(t.parentNode) || t), n
                    }, n.sortStable = x.split("").sort(j).join("") === x, n.detectDuplicates = !!d, p(), n.sortDetached = ue((function (e) {
                ...
                (w.fn.init = function (e, t, n) {
                    ...
                    if (n = n || q, "string" == typeof e) {
                        ...
                        if (r[1]) {
                            if (t = t instanceof w ? t[0] : t, w.merge(this, w.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : g, !0)), j.test(r[1]) && w.isPlainObject(t)) for (r in t) h(this[r]) ? this[r](t[r]) : this.attr(r, t[r]);
                            return this
                        }
                ...
                w.fn.extend({
                    has: function (e) {
                        ...
                        if (!k.test(e)) for (; r < i; r++) for (n = this[r]; n && n !== t; n = n.parentNode) if (n.nodeType < 11 && (s ? -1 < s.index(n) : 1 === n.nodeType && w.find.matchesSelector(n, e))) {
                            o.push(n);
                            break
                        }
                    ...
                    parent: function (e) {
                        ...
                        return null != e.contentDocument && r(e.contentDocument) ? e.contentDocument : (L(e, "template") && (e = e.content || e), w.merge([], e.childNodes))
                    }
                }, (function (e, t) {
                    w.fn[e] = function (n, r) {
                        var i = w.map(this, t, n);
                        return "Until" !== e.slice(-5) && (r = n), r && "string" == typeof r && (i = w.filter(r, i)), 1 < this.length && (B[e] || w.uniqueSort(i), P.test(e) && i.reverse()), this.pushStack(i)
                    }
                }));
                var M = /[^\x20\t\r\n\f]+/g;
                ...
                w.Callbacks = function (e) {
                    ...
                    var r, i, o, s, a = [], l = [], c = -1, u = function () {
                        for (s = s || e.once, o = r = !0; l.length; c = -1) for (i = l.shift(); ++c < a.length;) !1 === a[c].apply(i[0], i[1]) && e.stopOnFalse && (c = a.length, i = !1);
                        e.memory || (i = !1), r = !1, s && (a = i ? [] : "")
                    }, d = {
                        add: function () {
                            return a && (i && !r && (c = a.length - 1, l.push(i)), function t(n) {
                                w.each(n, (function (n, r) {
                                    h(r) ? e.unique && d.has(r) || a.push(r) : r && r.length && "string" !== b(r) && t(r)
                                }))
                    ...
                    Deferred: function (t) {
                            ...
                            r = "pending", i = {
                                state: function () {
                                        ...
                                        return function () {
                                            var a = this, l = arguments, c = function () {
                                                ...
                                                if (!(t < o)) {
                                                    ...
                                                    c = e && ("object" == typeof e || "function" == typeof e) && e.then, h(c) ? i ? c.call(e, s(o, n, O, i), s(o, n, _, i)) : (o++, c.call(e, s(o, n, O, i), s(o, n, _, i), s(o, n, O, n.notifyWith))) : (r !== O && (a = void 0, l = [e]), (i || n.resolveWith)(a, l))
                                                }
                                            }, u = i ? c : function () {
                                                try {
                                                    c()
                                                } catch (e) {
                                                    w.Deferred.exceptionHook && w.Deferred.exceptionHook(e, u.stackTrace), o <= t + 1 && (r !== _ && (a = void 0, l = [e]), n.rejectWith(a, l))
                                                }
                                            };
                                    ...
                                    return w.Deferred((function (e) {
                                        n[0][3].add(s(0, e, h(i) ? i : O, e.notifyWith)), n[1][3].add(s(0, e, h(t) ? t : O)), n[2][3].add(s(0, e, h(r) ? r : _))
                                    })).promise()
                                }, promise: function (e) {
                        ...
                        var t = arguments.length, n = t, r = Array(n), o = i.call(arguments), s = w.Deferred(),
                            a = function (e) {
                                return function (n) {
                                    r[e] = this, o[e] = 1 < arguments.length ? i.call(arguments) : n, --t || s.resolveWith(r, o)
                                }
                            };
                        if (t <= 1 && ($(e, s.done(a(n)).resolve, s.reject, !t), "pending" === s.state() || h(o[n] && o[n].then))) return s.then();
                ...
                function z() {
                    g.removeEventListener("DOMContentLoaded", z), e.removeEventListener("load", z), w.ready()
                }
                ...
                }), w.ready.then = H.then, "complete" === g.readyState || "loading" !== g.readyState && !g.documentElement.doScroll ? e.setTimeout(w.ready) : (g.addEventListener("DOMContentLoaded", z), e.addEventListener("load", z));
                var R = function (e, t, n, r, i, o, s) {
                    var a = 0, l = e.length, c = null == n;
                    if ("object" === b(n)) for (a in i = !0, n) R(e, t, a, n[a], !0, o, s); else if (void 0 !== r && (i = !0, h(r) || (s = !0), c && (s ? (t.call(e, r), t = null) : (c = t, t = function (e, t, n) {
                        return c.call(w(e), n)
                ...
                var U = new Y, J = new Y, K = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, Q = /[A-Z]/g;
                ...
                w.extend({
                    hasData: function (e) {
                        return J.hasData(e) || U.hasData(e)
                    }, data: function (e, t, n) {
                    ...
                    data: function (e, t) {
                        ...
                        if (void 0 === e) {
                            if (this.length && (i = J.get(o), 1 === o.nodeType && !U.get(o, "hasDataAttrs"))) {
                    ...
                    queue: function (e, t, n) {
                        var r;
                        if (e) return t = (t || "fx") + "queue", r = U.get(e, t), n && (!r || Array.isArray(n) ? r = U.access(e, t, w.makeArray(n)) : r.push(n)), r || []
                ...
                function ce(e, t) {
                    for (var n, r, i, o, s, a, l, c = [], u = 0, d = e.length; u < d; u++) (r = e[u]).style && (n = r.style.display, t ? ("none" === n && (c[u] = U.get(r, "display") || null, c[u] || (r.style.display = "")), "" === r.style.display && se(r) && (c[u] = (l = s = o = void 0, s = (i = r).ownerDocument, a = i.nodeName, (l = le[a]) || (o = s.body.appendChild(s.createElement(a)), l = w.css(o, "display"), o.parentNode.removeChild(o), "none" === l && (l = "block"), le[a] = l)))) : "none" !== n && (c[u] = "none", U.set(r, "display", n)));
                ...
                var ue, de, pe = /^(?:checkbox|radio)$/i, fe = /<([a-z][^\/\0>\x20\t\r\n\f]*)/i,
                ...
                function ge(e, t) {
                    var n;
                    return n = void 0 !== e.getElementsByTagName ? e.getElementsByTagName(t || "*") : void 0 !== e.querySelectorAll ? e.querySelectorAll(t || "*") : [], void 0 === t || t && L(e, t) ? w.merge([e], n) : n
                }
                ...
                function be(e, t, n, r, i) {
                    for (var o, s, a, l, c, u, d = t.createDocumentFragment(), p = [], f = 0, h = e.length; f < h; f++) if ((o = e[f]) || 0 === o) if ("object" === b(o)) w.merge(p, o.nodeType ? [o] : o); else if (ye.test(o)) {
                        for (s = s || d.appendChild(t.createElement("div")), a = (fe.exec(o) || ["", ""])[1].toLowerCase(), l = me[a] || me._default, s.innerHTML = l[1] + w.htmlPrefilter(o) + l[2], u = l[0]; u--;) s = s.lastChild;
                        w.merge(p, s.childNodes), (s = d.firstChild).textContent = ""
                    } else p.push(t.createTextNode(o));
                    for (d.textContent = "", f = 0; o = p[f++];) if (r && -1 < w.inArray(o, r)) i && i.push(o); else if (c = ie(o), s = ge(d.appendChild(o), "script"), c && ve(s), n) for (u = 0; o = s[u++];) he.test(o.type || "") && n.push(o);
                    return d
                }
                ...
                function Ce(e, t, n) {
                    n ? (U.set(e, t, !1), w.event.add(e, t, {
                        namespace: !1, handler: function (e) {
                            var r, o, s = U.get(this, t);
                            if (1 & e.isTrigger && this[t]) {
                                if (s.length) (w.event.special[t] || {}).delegateType && e.stopPropagation(); else if (s = i.call(arguments), U.set(this, t, s), r = n(this, t), this[t](), s !== (o = U.get(this, t)) || r ? U.set(this, t, !1) : o = {}, s !== o) return e.stopImmediatePropagation(), e.preventDefault(), o && o.value
                            } else s.length && (U.set(this, t, {value: w.event.trigger(w.extend(s[0], w.Event.prototype), s.slice(1), this)}), e.stopImmediatePropagation())
                        }
                ...
                w.event = {
                    global: {}, add: function (e, t, n, r, i) {
                        var o, s, a, l, c, u, d, p, f, h, m, g = U.get(e);
                        if (X(e)) for (n.handler && (n = (o = n).handler, i = o.selector), i && w.find.matchesSelector(re, i), n.guid || (n.guid = w.guid++), (l = g.events) || (l = g.events = Object.create(null)), (s = g.handle) || (s = g.handle = function (t) {
                            return void 0 !== w && w.event.triggered !== t.type ? w.event.dispatch.apply(e, arguments) : void 0
                        }), c = (t = (t || "").match(M) || [""]).length; c--;) f = m = (a = xe.exec(t[c]) || [])[1], h = (a[2] || "").split(".").sort(), f && (d = w.event.special[f] || {}, f = (i ? d.delegateType : d.bindType) || f, d = w.event.special[f] || {}, u = w.extend({
                            type: f,
                            origType: m,
                            data: r,
                            handler: n,
                            ...
                            namespace: h.join(".")
                        }, o), (p = l[f]) || ((p = l[f] = []).delegateCount = 0, d.setup && !1 !== d.setup.call(e, r, h, s) || e.addEventListener && e.addEventListener(f, s)), d.add && (d.add.call(e, u), u.handler.guid || (u.handler.guid = n.guid)), i ? p.splice(p.delegateCount++, 0, u) : p.push(u), w.event.global[f] = !0)
                    }, remove: function (e, t, n, r, i) {
                        var o, s, a, l, c, u, d, p, f, h, m, g = U.hasData(e) && U.get(e);
                        if (g && (l = g.events)) {
                            for (c = (t = (t || "").match(M) || [""]).length; c--;) if (f = m = (a = xe.exec(t[c]) || [])[1], h = (a[2] || "").split(".").sort(), f) {
                                for (d = w.event.special[f] || {}, p = l[f = (r ? d.delegateType : d.bindType) || f] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = p.length; o--;) u = p[o], !i && m !== u.origType || n && n.guid !== u.guid || a && !a.test(u.namespace) || r && r !== u.selector && ("**" !== r || !u.selector) || (p.splice(o, 1), u.selector && p.delegateCount--, d.remove && d.remove.call(e, u));
                                s && !p.length && (d.teardown && !1 !== d.teardown.call(e, h, g.handle) || w.removeEvent(e, f, g.handle), delete l[f])
                            } else for (f in l) w.event.remove(e, f + t[c], n, r, !0);
                            w.isEmptyObject(l) && U.remove(e, "handle events")
                        }
                    }, dispatch: function (e) {
                        var t, n, r, i, o, s, a = new Array(arguments.length), l = w.event.fix(e),
                        ...
                        load: {noBubble: !0}, click: {
                            setup: function (e) {
                                var t = this || e;
                                return pe.test(t.type) && t.click && L(t, "input") && Ce(t, "click", we), !1
                            }, trigger: function (e) {
                                var t = this || e;
                                return pe.test(t.type) && t.click && L(t, "input") && Ce(t, "click"), !0
                            }, _default: function (e) {
                                var t = e.target;
                                return pe.test(t.type) && t.click && L(t, "input") && U.get(t, "click") || L(t, "a")
                            }
                        }, beforeunload: {
                    ...
                    e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? we : Se, this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget) : this.type = e, t && w.extend(this, t), this.timeStamp = e && e.timeStamp || Date.now(), this[w.expando] = !0
                }, w.Event.prototype = {
                    constructor: w.Event,
                ...
                function Ae(e, t) {
                    return L(e, "table") && L(11 !== t.nodeType ? t : t.firstChild, "tr") && w(e).children("tbody")[0] || e
                }
                ...
                function Pe(e, t) {
                    var n, r, i, o, s, a;
                    if (1 === t.nodeType) {
                        if (U.hasData(e) && (a = U.get(e).events)) for (i in U.remove(t, "handle events"), a) for (n = 0, r = a[i].length; n < r; n++) w.event.add(t, i, a[i][n]);
                ...
                function Be(e, t, n, r) {
                    t = o(t);
                    var i, s, a, l, c, u, d = 0, p = e.length, m = p - 1, g = t[0], v = h(g);
                    ...
                    if (p && (s = (i = be(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === i.childNodes.length && (i = s), s || r)) {
                        for (l = (a = w.map(ge(i, "script"), qe)).length; d < p; d++) c = i, d !== m && (c = w.clone(c, !0, !0), l && w.merge(a, ge(c, "script"))), n.call(e[d], c, d);
                        if (l) for (u = a[a.length - 1].ownerDocument, w.map(a, De), d = 0; d < l; d++) c = a[d], he.test(c.type || "") && !U.access(c, "globalEval") && w.contains(u, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? w._evalUrl && !c.noModule && w._evalUrl(c.src, {nonce: c.nonce || c.getAttribute("nonce")}, u) : y(c.textContent.replace(je, ""), c, u))
                    }
                    return e
                }
                ...
                w.extend({
                    htmlPrefilter: function (e) {
                        ...
                        var r, i, o, s, a, l, c, u = e.cloneNode(!0), d = ie(e);
                        if (!(f.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || w.isXMLDoc(e))) for (s = ge(u), r = 0, i = (o = ge(e)).length; r < i; r++) a = o[r], "input" === (c = (l = s[r]).nodeName.toLowerCase()) && pe.test(a.type) ? l.checked = a.checked : "input" !== c && "textarea" !== c || (l.defaultValue = a.defaultValue);
                        if (t) if (n) for (o = o || ge(e), s = s || ge(u), r = 0, i = o.length; r < i; r++) Pe(o[r], s[r]); else Pe(e, u);
                        return 0 < (s = ge(u, "script")).length && ve(s, !d && ge(e, "script")), u
                    }, cleanData: function (e) {
                        for (var t, n, r, i = w.event.special, o = 0; void 0 !== (n = e[o]); o++) if (X(n)) {
                            if (t = n[U.expando]) {
                    ...
                    detach: function (e) {
                        ...
                        return R(this, (function (e) {
                            ...
                            if ("string" == typeof e && !ke.test(e) && !me[(fe.exec(e) || ["", ""])[1].toLowerCase()]) {
                                e = w.htmlPrefilter(e);
                                try {
                ...
                var Me = new RegExp("^(" + ee + ")(?!px)[a-z%]+$", "i"), Oe = function (t) {
                ...
                function Ie(e, t, n) {
                    ...
                    return (n = n || Oe(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || ie(e) || (s = w.style(e, t)), !f.pixelBoxStyles() && Me.test(s) && $e.test(t) && (r = a.width, i = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = r, a.minWidth = i, a.maxWidth = o)), void 0 !== s ? s + "" : s
                }
                ...
                !function () {
                    ...
                    var r, i, o, s, a, l, c = g.createElement("div"), u = g.createElement("div");
                ...
                var ze = ["Webkit", "Moz", "ms"], Re = g.createElement("div").style, Ge = {};

                function Fe(e) {
                    return w.cssProps[e] || Ge[e] || (e in Re ? e : Ge[e] = function (e) {
                        for (var t = e[0].toUpperCase() + e.slice(1), n = ze.length; n--;) if ((e = ze[n] + t) in Re) return e
                    }(e) || e)
                }

                var We = /^(none|table(?!-c[ea]).+)/, Ve = /^--/,
                ...
                function Ke(e, t, n) {
                    var r = Oe(e), i = (!f.boxSizingReliable() || n) && "border-box" === w.css(e, "boxSizing", !1, r),
                        o = i, s = Ie(e, t, r), a = "offset" + t[0].toUpperCase() + t.slice(1);
                    if (Me.test(s)) {
                        if (!n) return s;
                        s = "auto"
                    }
                    return (!f.boxSizingReliable() && i || !f.reliableTrDimensions() && L(e, "tr") || "auto" === s || !parseFloat(s) && "inline" === w.css(e, "display", !1, r)) && e.getClientRects().length && (i = "border-box" === w.css(e, "boxSizing", !1, r), (o = a in e) && (s = e[a])), (s = parseFloat(s) || 0) + Je(e, t, n || (i ? "border" : "content"), o, r, s) + "px"
                }
                ...
                w.extend({
                    ...
                    style: function (e, t, n, r) {
                        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                            var i, o, s, a = V(t), l = Ve.test(t), c = e.style;
                            if (l || (t = Fe(a)), s = w.cssHooks[t] || w.cssHooks[a], void 0 === n) return s && "get" in s && void 0 !== (i = s.get(e, !1, r)) ? i : c[t];
                            "string" == (o = typeof n) && (i = te.exec(n)) && i[1] && (n = ae(e, t, i), o = "number"), null != n && n == n && ("number" !== o || l || (n += i && i[3] || (w.cssNumber[a] ? "" : "px")), f.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, r)) || (l ? c.setProperty(t, n) : c[t] = n))
                        }
                    },
                    css: function (e, t, n, r) {
                        var i, o, s, a = V(t);
                        return Ve.test(t) || (t = Fe(a)), (s = w.cssHooks[t] || w.cssHooks[a]) && "get" in s && (i = s.get(e, !0, n)), void 0 === i && (i = Ie(e, t, r)), "normal" === i && t in Ye && (i = Ye[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i
                    }
                }), w.each(["height", "width"], (function (e, t) {
                    w.cssHooks[t] = {
                        get: function (e, n, r) {
                            if (n) return !We.test(w.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Ke(e, t, r) : _e(e, Xe, (function () {
                                return Ke(e, t, r)
                            }))
                        }, set: function (e, n, r) {
                            var i, o = Oe(e), s = !f.scrollboxSize() && "absolute" === o.position,
                                a = (s || r) && "border-box" === w.css(e, "boxSizing", !1, o),
                                l = r ? Je(e, t, r, a, o) : 0;
                            return a && s && (l -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(o[t]) - Je(e, t, "border", !1, o) - .5)), l && (i = te.exec(n)) && "px" !== (i[3] || "px") && (e.style[t] = n, n = w.css(e, t)), Ue(0, n, l)
                        }
                    }
                })), w.cssHooks.marginLeft = He(f.reliableMarginLeft, (function (e, t) {
                    if (t) return (parseFloat(Ie(e, "marginLeft")) || e.getBoundingClientRect().left - _e(e, {marginLeft: 0}, (function () {
                    ...
                    css: function (e, t) {
                        return R(this, (function (e, t, n) {
                            var r, i, o = {}, s = 0;
                            if (Array.isArray(t)) {
                                for (r = Oe(e), i = t.length; s < i; s++) o[t[s]] = w.css(e, t[s], !1, r);
                                return o
                            }
                            return void 0 !== n ? w.style(e, t, n) : w.css(e, t)
                        }), e, t, 1 < arguments.length)
                    }
                }), ((w.Tween = Qe).prototype = {
                    constructor: Qe, init: function (e, t, n, r, i, o) {
                        ...
                        return this.options.duration ? this.pos = t = w.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration) : this.pos = t = e, this.now = (this.end - this.start) * t + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : Qe.propHooks._default.set(this), this
                    }
                ...
                function lt(e, t, n) {
                    for (var r, i = (ct.tweeners[t] || []).concat(ct.tweeners["*"]), o = 0, s = i.length; o < s; o++) if (r = i[o].call(n, t, e)) return r
                }

                function ct(e, t, n) {
                    var r, i, o = 0, s = ct.prefilters.length, a = w.Deferred().always((function () {
                        delete l.elem
                    })), l = function () {
                        if (i) return !1;
                        for (var t = Ze || st(), n = Math.max(0, c.startTime + c.duration - t), r = 1 - (n / c.duration || 0), o = 0, s = c.tweens.length; o < s; o++) c.tweens[o].run(r);
                    ...
                    for (function (e, t) {
                        var n, r, i, o, s;
                        for (n in e) if (i = t[r = V(n)], o = e[n], Array.isArray(o) && (i = o[1], o = e[n] = o[0]), n !== r && (e[r] = o, delete e[n]), (s = w.cssHooks[r]) && "expand" in s) for (n in o = s.expand(o), delete e[r], o) n in e || (e[n] = o[n], t[n] = i); else t[r] = i
                    }(u, c.opts.specialEasing); o < s; o++) if (r = ct.prefilters[o].call(c, e, u, c.opts)) return h(r.stop) && (w._queueHooks(c.elem, c.opts.queue).stop = r.stop.bind(r)), r;
                ...
                w.Animation = w.extend(ct, {
                    tweeners: {
                        ...
                        var r, i, o, s, a, l, c, u, d = "width" in t || "height" in t, p = this, f = {}, h = e.style,
                        ...
                        if ((l = !w.isEmptyObject(t)) || !w.isEmptyObject(f)) for (r in d && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (c = g && g.display) && (c = U.get(e, "display")), "none" === (u = w.css(e, "display")) && (c ? u = c : (ce([e], !0), c = e.style.display || c, u = w.css(e, "display"), ce([e]))), ("inline" === u || "inline-block" === u && null != c) && "none" === w.css(e, "float") && (l || (p.done((function () {
                            h.display = c
                        })), null == c && (u = h.display, c = "none" === u ? "" : u)), h.display = "inline-block")), n.overflow && (h.overflow = "hidden", p.always((function () {
                            h.overflow = n.overflow[0], h.overflowX = n.overflow[1], h.overflowY = n.overflow[2]
                        }))), l = !1, f) l || (g ? "hidden" in g && (m = g.hidden) : g = U.access(e, "fxshow", {display: c}), o && (g.hidden = !m), m && ce([e], !0), p.done((function () {
                            for (r in m || ce([e]), U.remove(e, "fxshow"), f) w.style(e, r, f[r])
                    ...
                    fadeTo: function (e, t, n, r) {
                        ...
                        var i = w.isEmptyObject(e), o = w.speed(t, n, r), s = function () {
                        ...
                        return "string" != typeof e && (n = t, t = e, e = void 0), t && this.queue(e || "fx", []), this.each((function () {
                            var t = !0, i = null != e && e + "queueHooks", o = w.timers, s = U.get(this);
                        ...
                        return !1 !== e && (e = e || "fx"), this.each((function () {
                            var t, n = U.get(this), r = n[e + "queue"], i = n[e + "queueHooks"], o = w.timers,
                                s = r ? r.length : 0;
                ...
                w.fn.extend({
                    ...
                    attr: function (e, t, n) {
                        ...
                        if (3 !== o && 8 !== o && 2 !== o) return void 0 === e.getAttribute ? w.prop(e, t, n) : (1 === o && w.isXMLDoc(e) || (i = w.attrHooks[t.toLowerCase()] || (w.expr.match.bool.test(t) ? ut : void 0)), void 0 !== n ? null === n ? void w.removeAttr(e, t) : i && "set" in i && void 0 !== (r = i.set(e, n, t)) ? r : (e.setAttribute(t, n + ""), n) : i && "get" in i && null !== (r = i.get(e, t)) ? r : null == (r = w.find.attr(e, t)) ? void 0 : r)
                    }, attrHooks: {
                        type: {
                            set: function (e, t) {
                ...
                w.fn.extend({
                    ...
                    addClass: function (e) {
                        ...
                        return "boolean" == typeof t && r ? t ? this.addClass(e) : this.removeClass(e) : h(e) ? this.each((function (n) {
                            ...
                            var t, i, o, s;
                            if (r) for (i = 0, o = w(this), s = gt(e); t = s[i++];) o.hasClass(t) ? o.removeClass(t) : o.addClass(t); else void 0 !== e && "boolean" !== n || ((t = mt(this)) && U.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : U.get(this, "__className__") || ""))
                        }))
                    }, hasClass: function (e) {
                        var t, n, r = 0;
                        for (t = " " + e + " "; n = this[r++];) if (1 === n.nodeType && -1 < (" " + ht(mt(n)) + " ").indexOf(t)) return !0;
                        return !1
                    }
                });
                var vt = /\r/g;
                        ...
                        option: {
                            ...
                            get: function (e) {
                                var t, n, r, i = e.options, o = e.selectedIndex, s = "select-one" === e.type,
                                    a = s ? null : [], l = s ? o + 1 : i.length;
                                for (r = o < 0 ? l : s ? o : 0; r < l; r++) if (((n = i[r]).selected || r === o) && !n.disabled && (!n.parentNode.disabled || !L(n.parentNode, "optgroup"))) {
                ...
                w.extend(w.event, {
                    trigger: function (t, n, r, i) {
                        var o, s, a, l, c, d, p, f, v = [r || g], y = u.call(t, "type") ? t.type : t,
                            b = u.call(t, "namespace") ? t.namespace.split(".") : [];
                        if (s = f = a = r = r || g, 3 !== r.nodeType && 8 !== r.nodeType && !yt.test(y + w.event.triggered) && (-1 < y.indexOf(".") && (y = (b = y.split(".")).shift(), b.sort()), c = y.indexOf(":") < 0 && "on" + y, (t = t[w.expando] ? t : new w.Event(y, "object" == typeof t && t)).isTrigger = i ? 2 : 3, t.namespace = b.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + b.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : w.makeArray(n, [t]), p = w.event.special[y] || {}, i || !p.trigger || !1 !== p.trigger.apply(r, n))) {
                            if (!i && !p.noBubble && !m(r)) {
                            ...
                            for (o = 0; (s = v[o++]) && !t.isPropagationStopped();) f = s, t.type = 1 < o ? l : p.bindType || y, (d = (U.get(s, "events") || Object.create(null))[t.type] && U.get(s, "handle")) && d.apply(s, n), (d = c && s[c]) && d.apply && X(s) && (t.result = d.apply(s, n), !1 === t.result && t.preventDefault());
                            return t.type = y, i || t.isDefaultPrevented() || p._default && !1 !== p._default.apply(v.pop(), n) || !X(r) || c && h(r[y]) && !m(r) && ((a = r[c]) && (r[c] = null), w.event.triggered = y, t.isPropagationStopped() && f.addEventListener(y, bt), r[y](), t.isPropagationStopped() && f.removeEventListener(y, bt), w.event.triggered = void 0, a && (r[c] = a)), t.result
                        }
                ...
                var xt = e.location, wt = {guid: Date.now()}, St = /\?/;
                ...
                function Lt(e, t, n, r) {
                    ...
                    if (Array.isArray(t)) w.each(t, (function (t, i) {
                        n || Tt.test(e) ? r(e, i) : Lt(e + "[" + ("object" == typeof i && null != i ? t : "") + "]", i, n, r)
                    })); else if (n || "object" !== b(t)) r(e, t); else for (i in t) Lt(e + "[" + i + "]", t[i], n, r)
                }
                ...
                var jt = /%20/g, At = /#.*$/, qt = /([?&])_=[^&]*/, Dt = /^(.*?):[ \t]*([^\r\n]*)$/gm,
                    Pt = /^(?:GET|HEAD)$/, Bt = /^\/\//, Nt = {}, Mt = {}, Ot = "*/".concat("*"),
                ...
                _t.href = xt.href, w.extend({
                    ...
                    ajax: function (t, n) {
                        ...
                        var r, i, o, s, a, l, c, u, d, p, f = w.ajaxSetup({}, n), h = f.context || f,
                            m = f.context && (h.nodeType || h.jquery) ? w(h) : w.event, v = w.Deferred(),
                            y = w.Callbacks("once memory"), b = f.statusCode || {}, x = {}, S = {}, T = "canceled",
                            E = {
                        ...
                        if (v.promise(E), f.url = ((t || f.url || xt.href) + "").replace(Bt, xt.protocol + "//"), f.type = n.method || n.type || f.method || f.type, f.dataTypes = (f.dataType || "*").toLowerCase().match(M) || [""], null == f.crossDomain) {
                            l = g.createElement("a");
                            try {
                        ...
                        if (f.data && f.processData && "string" != typeof f.data && (f.data = w.param(f.data, f.traditional)), It(Nt, f, n, E), c) return E;
                        for (d in (u = w.event && f.global) && 0 == w.active++ && w.event.trigger("ajaxStart"), f.type = f.type.toUpperCase(), f.hasContent = !Pt.test(f.type), i = f.url.replace(At, ""), f.hasContent ? f.data && f.processData && 0 === (f.contentType || "").indexOf("application/x-www-form-urlencoded") && (f.data = f.data.replace(jt, "+")) : (p = f.url.slice(i.length), f.data && (f.processData || "string" == typeof f.data) && (i += (St.test(i) ? "&" : "?") + f.data, delete f.data), !1 === f.cache && (i = i.replace(qt, "$1"), p = (St.test(i) ? "&" : "?") + "_=" + wt.guid++ + p), f.url = i + p), f.ifModified && (w.lastModified[i] && E.setRequestHeader("If-Modified-Since", w.lastModified[i]), w.etag[i] && E.setRequestHeader("If-None-Match", w.etag[i])), (f.data && f.hasContent && !1 !== f.contentType || n.contentType) && E.setRequestHeader("Content-Type", f.contentType), E.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + Ot + "; q=0.01" : "") : f.accepts["*"]), f.headers) E.setRequestHeader(d, f.headers[d]);
                        if (f.beforeSend && (!1 === f.beforeSend.call(h, E, f) || c)) return E.abort();
                        if (T = "abort", y.add(f.complete), E.done(f.success), E.fail(f.error), r = It(Mt, f, n, E)) {
                        ...
                        function C(t, n, s, l) {
                            var d, p, g, x, S, T = n;
                            c || (c = !0, a && e.clearTimeout(a), r = void 0, o = l || "", E.readyState = 0 < t ? 4 : 0, d = 200 <= t && t < 300 || 304 === t, s && (x = function (e, t, n) {
                            ...
                            }(f, E, s)), !d && -1 < w.inArray("script", f.dataTypes) && w.inArray("json", f.dataTypes) < 0 && (f.converters["text script"] = function () {
                            }), x = function (e, t, n, r) {
                            ...
                            }(f, x, E, d), d ? (f.ifModified && ((S = E.getResponseHeader("Last-Modified")) && (w.lastModified[i] = S), (S = E.getResponseHeader("etag")) && (w.etag[i] = S)), 204 === t || "HEAD" === f.type ? T = "nocontent" : 304 === t ? T = "notmodified" : (T = x.state, p = x.data, d = !(g = x.error))) : (g = T, !t && T || (T = "error", t < 0 && (t = 0))), E.status = t, E.statusText = (n || T) + "", d ? v.resolveWith(h, [p, T, E]) : v.rejectWith(h, [E, T, g]), E.statusCode(b), b = void 0, u && m.trigger(d ? "ajaxSuccess" : "ajaxError", [E, f, d ? p : g]), y.fireWith(h, [E, T]), u && (m.trigger("ajaxComplete", [E, f]), --w.active || w.event.trigger("ajaxStop")))
                        }
                ...
                var zt = {0: 200, 1223: 204}, Rt = w.ajaxSettings.xhr();
                f.cors = !!Rt && "withCredentials" in Rt, f.ajax = Rt = !!Rt, w.ajaxTransport((function (t) {
                    var n, r;
                    if (f.cors || Rt && !t.crossDomain) return {
                        send: function (i, o) {
                            ...
                            n = function (e) {
                                return function () {
                                    n && (n = r = a.onload = a.onerror = a.onabort = a.ontimeout = a.onreadystatechange = null, "abort" === e ? a.abort() : "error" === e ? "number" != typeof a.status ? o(0, "error") : o(a.status, a.statusText) : o(zt[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {binary: a.response} : {text: a.responseText}, a.getAllResponseHeaders()))
                                }
                ...
                w.ajaxSetup({
                    ...
                    if (a || "jsonp" === t.dataTypes[0]) return i = t.jsonpCallback = h(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(Wt, "$1" + i) : !1 !== t.jsonp && (t.url += (St.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function () {
                        return s || w.error(i + " was not called"), s[0]
                    }, t.dataTypes[0] = "json", o = e[i], e[i] = function () {
                        s = arguments
                    }, r.always((function () {
                        void 0 === o ? w(e).removeProp(i) : e[i] = o, t[i] && (t.jsonpCallback = n.jsonpCallback, Ft.push(i)), s && h(o) && o(s[0]), s = o = void 0
                    })), "script"
                })), f.createHTMLDocument = ((Gt = g.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Gt.childNodes.length), w.parseHTML = function (e, t, n) {
                    return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (f.createHTMLDocument ? ((r = (t = g.implementation.createHTMLDocument("")).createElement("base")).href = g.location.href, t.head.appendChild(r)) : t = g), o = !n && [], (i = j.exec(e)) ? [t.createElement(i[1])] : (i = be([e], t, o), o && o.length && w(o).remove(), w.merge([], i.childNodes)));
                    var r, i, o
                }, w.fn.load = function (e, t, n) {
                    var r, i, o, s = this, a = e.indexOf(" ");
                    return -1 < a && (r = ht(e.slice(a)), e = e.slice(0, a)), h(t) ? (n = t, t = void 0) : t && "object" == typeof t && (i = "POST"), 0 < s.length && w.ajax({
                        url: e,
                        type: i || "GET",
                        dataType: "html",
                        data: t
                    ...
                    setOffset: function (e, t, n) {
                        var r, i, o, s, a, l, c = w.css(e, "position"), u = w(e), d = {};
                        "static" === c && (e.style.position = "relative"), a = u.offset(), o = w.css(e, "top"), l = w.css(e, "left"), ("absolute" === c || "fixed" === c) && -1 < (o + l).indexOf("auto") ? (s = (r = u.position()).top, i = r.left) : (s = parseFloat(o) || 0, i = parseFloat(l) || 0), h(t) && (t = t.call(e, n, w.extend({}, a))), null != t.top && (d.top = t.top - a.top + s), null != t.left && (d.left = t.left - a.left + i), "using" in t ? t.using.call(e, d) : u.css(d)
                    }
                }, w.fn.extend({
                    offset: function (e) {
                    ...
                    w.cssHooks[t] = He(f.pixelPosition, (function (e, n) {
                        if (n) return n = Ie(e, t), Me.test(n) ? w(e).position()[t] + "px" : n
                    }))
                ...
                }, w.isArray = Array.isArray, w.parseJSON = JSON.parse, w.nodeName = L, w.isFunction = h, w.isWindow = m, w.camelCase = V, w.type = b, w.now = Date.now, w.isNumeric = function (e) {
                    var t = w.type(e);
            ...
            const t = document.querySelectorAll(".--js_link"), n = document.querySelector("body"),
                r = document.querySelectorAll(".--js_fixed"), i = 800,
                o = document.querySelectorAll(".--js_close-pop-up");
            let s = !0;
            const a = document.querySelector(".--js_video");
            if (t.length > 0) for (let n = 0; n < t.length; n++) {
                const r = t[n];
                r.addEventListener("click", (function (t) {
                    e(a);
                    const n = r.getAttribute("href").replace("#", "");
                    l(document.getElementById(n)), t.preventDefault()
                }))
            }
            if (o.length > 0) for (let t = 0; t < o.length; t++) {
                const n = o[t];
                n.addEventListener("click", (function (t) {
                    e(a), c(n.closest(".--js-popup")), t.preventDefault()
                }))
            }

            function l(e) {
                if (e && s) {
                    const t = document.querySelector(".--js-popup.--js_open-pop-up");
                    t ? c(t, !1) : function () {
                        const e = window.innerWidth - document.querySelector(".wrapper").offsetWidth + "px";
                        if (r.length > 0) for (let t = 0; t < r.length; t++) r[t].style.paddingRight = e;
                        if (n.classList.add("--js-lock__body"), s = !1, setTimeout((function () {
                            s = !0
                        }), i), r.length > 0) for (let t = 0; t < r.length; t++) r[t].getElementsByClassName.paddingRight = e;
                        n.classList.add("--js-lock__body"), s = !1, setTimeout((function () {
                            s = !0
                        }), i)
                    }(), e.classList.add("--js_open-pop-up")
                }
            }

            function c(e, t = !0) {
                s && (e.classList.remove("--js_open-pop-up"), t && (setTimeout((function () {
                    if (r.length > 0) for (let e = 0; e < r.length; e++) r[e].style.paddingRight = "0px";
                    n.classList.remove("--js-lock__body")
            ...
            document.addEventListener("keydown", (function (e) {
                27 === e.which && c(document.querySelector(".--js-popup.--js_open-pop-up"))
                ...
                return null
            }), Element.prototype.matches || (Element.prototype.matches = Element.prototype.matchesSelector || Element.prototype.webkitMatchesSelector || Element.prototype.mozMatchesSelector || Element.prototype.matchesSelector)
        }(), async function () {
            !function () {
                ...
                window.addEventListener("touchstart", (r => {
                    ...
                    let o = t + -3e3, s = n + -2e3;
                    e.style.left = o + "px", e.style.top = s + "px", e.classList.toggle("--js-mask-touch")
                })), window.addEventListener("touchmove", (r => {
                    if (!t || !n) return !1;
                    let i = r.touches[0].clientX + -3e3, o = r.touches[0].clientY + -2e3;
            ...
            window.addEventListener("mousemove", (t => {
                if (!t.target) return;
                let n = t.pageX + -3e3, r = t.pageY + -2e3;
                e.style.left = n + "px", e.style.top = r + "px"
            }))
        }(), ee(), function () {
            const e = document.getElementById("formMess"), t = document.getElementById("btnToMessage");
            e.addEventListener("submit", (function (n) {
                n.stopPropagation(), n.preventDefault(), 0 === function (e) {
                    let t = 0, n = document.querySelectorAll("._req");
                    for (let e = 0; e < n.length; e++) {
                        const r = n[e];
                        re(r), r.classList.contains("_email") ? ie(r) && (ne(r), t++) : ("" === r.value || "checkbox" === r.getAttribute("type") && !1 === r.checked) && (ne(r), t++)
                    }
                    return t
                }() && (e.classList.add("_sending"), function (n) {
                    let r = n, i = ($(".submit", r), new FormData), o = $("input[type=file]");
                    $(".submit", r).val("Отправка..."), $("input, textarea", r).attr("disabled", ""), i.append("email", $('[name="email"]', r).val()), i.append("text", $('[name="message"]', r).val()), o.each((function (e, t) {
                        let n = t.files;
                        ...
                        xhr: function () {
                            ...
                            return e.upload && e.upload.addEventListener("progress", (function (e) {
                                if (e.lengthComputable) {
                                    ...
                                    t = t.toFixed(0), $(".submit", r).html(t + "%")
                                }
                            }), !1), e
                        },
                        complete: function () {
                            r.reset(), e.classList.remove("_sending"), t.click()
                        }
                    })
                }(this))
            }))
        }(), function () {
            const e = document.querySelectorAll(".burger__icon"), t = document.body;
            if (e.length > 0) for (let n = 0; n < e.length; n++) e[n].addEventListener("click", (function (e) {
                t.classList.toggle("--js-lock__body--burgerMenu"), e.preventDefault()
            }))
        }()
    }))
})();